...
" Last Change:	November 30, 2006
" Version:	1
" URL:		http://www.ehu.es/isilanes
"
" Notes: {{{1
"
...
" By ISC:
" Highlight '\ig{blah}{blah-blah}' (my shortcut for \includegraphics):
" The following means: a literal '\ig{', plus either (0 or 1 or nothing), plus a literal dot, 
" plus one or more digits, plus one or more characters (any) between {}.
syn match texInputFile	"\\ig{[01]\?\.[0-9]\+}{.\+}" contains=texStatement,texInputCurlies
" Lines ending in spaces show errors:
syn match Error " \+$"me=e-1
